...
{
    /// <inheritdoc />
    public partial class AddsAmortizationScheduleSp : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			var sp = @"CREATE PROCEDURE [dbo].[GetAmortizationSchedule] (
...
";
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[GetAmortizationSchedule]");
        }
    }
}
